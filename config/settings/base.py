...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres://localhost/scute")
}
...
MIGRATION_MODULES = {"sites": "scute.contrib.sites.migrations"}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "scute.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
